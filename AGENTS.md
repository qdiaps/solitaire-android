...
4. **Atomic Steps:** Pick only ONE task (or subtask) from `docs/TASKS.md` at a time. Do not implement unrequested features or bundle multiple steps together.
5. **Architectural Decisions & Ambiguity Resolution (ADR Protocol):**
